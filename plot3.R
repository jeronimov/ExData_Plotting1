...
if(size < totalRam/2){
  ...
  # Plot the Scatterplot x=Date_time y=Sub_metering_1
  with(data, plot(Date_time, Sub_metering_1, xlab="", ylab="Energy sub metering", type="l"))
  ...
  # Add legend
  legend("topright", lwd=2, cex=0.8, col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
